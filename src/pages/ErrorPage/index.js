    ...
    return (
        <>
            ...
            <Box display="flex" width="100%" height="100vh" alignItems="center" justifyContent="center">
                <Box mb={15}>
                    <Typography  fontSize={{xs: "4rem", sm: "6rem", md: "8rem", lg: "10rem"}} variant="h1" sx={{color: "#333", fontWeight: 700, fontFamily: "'Sen', Segeo UI, sans-serif", textAlign: "center"}}>404!</Typography>
